    ...
    return (
        <div className='bg-white p-2 rounded-2xl shadow-md text-gray-500 mt-6 font-medium' >
            <div className='flex space-x-4 p-4 items-center' >
              ...
              {imageToPost && (
                   <div onClick={removeImageFromPost} className='flex flex-col
                    filter hover:brightness-110 transition duration-150 transform hover:scale-105
                    cursor-pointer' >
                     <img 
                      className='h-10 object-contain '
                      src={imageToPost} alt='Post Image' />
